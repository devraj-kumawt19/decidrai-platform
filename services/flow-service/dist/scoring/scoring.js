...
exports.calculateTagScore = calculateTagScore;
exports.applyWeights = applyWeights;
exports.rankToolsByScore = rankToolsByScore;
/**
 * Calculate tag overlap score between user tags and tool tags
 * Returns a score between 0 and 100
 */
function calculateTagScore(toolTags, userTags, requiredTags = [], optionalTags = []) {
 ...
 */
function applyWeights(baseScore, toolAttributes, userPreferences, weights) {
 ...
 * Rank tools by score
 */
function rankToolsByScore(tools) {
