...
async function seed() {
    try {
        ...
        await (0, db_1.connectMongo)(process.env.MONGODB_URI, process.env.MONGODB_DB_NAME || 'decidrai_flows');
        // Clear existing flows
        await Flow_1.Flow.deleteMany({});
        console.log('🗑️  Cleared existing flows');
        // Insert sample flows
        const result = await Flow_1.Flow.insertMany(sampleFlows);
