...
app.use((0, logger_1.createRequestLogger)('comparison-service'));
...
// Comparison routes
app.use('/', comparison_routes_1.default);
// 404 handler
app.use((req, res) => {
    res.status(404).json({
        success: false,
...
async function startServer() {
    try {
        ...
        await (0, db_1.connectMongo)(process.env.MONGODB_URI, process.env.MONGODB_DB_NAME || 'decidrai_comparisons');
