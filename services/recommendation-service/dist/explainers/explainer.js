...
exports.generateTemplateExplanation = generateTemplateExplanation;
exports.generateAIExplanation = generateAIExplanation;
exports.generateExplanations = generateExplanations;
 ...
 */
function generateTemplateExplanation(tool, userTags, matchedTags, score) {
 ...
 */
async function generateAIExplanation(tool, userTags, matchedTags, score) {
 ...
 */
async function generateExplanations(scoredTools, userTags, useAI = true) {
